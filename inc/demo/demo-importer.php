 ...
 * Define demo file
 */
function delivery_import_files() {
	return array(
		array(
...
add_filter( 'pt-ocdi/import_files', 'delivery_import_files' );

/**
 * After import function
 */
function delivery_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'delivery_after_import_setup' );
