<article <?php hybrid_attr( 'post' ); ?>>
	...
	<?php if ( is_attachment() ) : // If viewing a single attachment. ?>
		...
		<header class="entry-header">
			...
			<div class="entry-byline">
				<span class="image-sizes"><?php printf( __( 'Sizes: %s', 'basic' ), hybrid_get_image_size_links() ); ?></span>
			</div><!-- .entry-byline -->
	...
	<?php else : // If not viewing a single post. ?>
		...
		<?php get_the_image( array( 'size' => 'basic-full', 'order' => array( 'featured', 'attachment' ) ) ); ?>
...
<?php if ( is_attachment() ) : // If viewing a single attachment. ?>
	...
	<div class="attachment-meta">
		...
		<div class="media-info image-info">
			...
			<h3 class="attachment-meta-title"><?php _e( 'Image Info', 'basic' ); ?></h3>
		...
		<?php if ( !empty( $gallery ) ) : // Check if the gallery is not empty. ?>
			...
			<div class="image-gallery">
				<h3 class="attachment-meta-title"><?php _e( 'Gallery', 'basic' ); ?></h3>
				<?php echo $gallery; ?>
			</div>
