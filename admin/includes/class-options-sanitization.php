...
function of_recognized_background_repeat() {
	$default = array(
		...
		'repeat-x'  => __( 'Repeat Horizontally', 'basic' ),
		'repeat-y'  => __( 'Repeat Vertically', 'basic' ),
		'repeat'    => __( 'Repeat All', 'basic' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'basic' ),
		'top center'    => __( 'Top Center', 'basic' ),
		'top right'     => __( 'Top Right', 'basic' ),
		'center left'   => __( 'Middle Left', 'basic' ),
		'center center' => __( 'Middle Center', 'basic' ),
		'center right'  => __( 'Middle Right', 'basic' ),
		'bottom left'   => __( 'Bottom Left', 'basic' ),
		'bottom center' => __( 'Bottom Center', 'basic' ),
		'bottom right'  => __( 'Bottom Right', 'basic')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'basic' ),
		'fixed'  => __( 'Fixed in Place', 'basic')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'basic' ),
		'italic'      => __( 'Italic', 'basic' ),
		'bold'        => __( 'Bold', 'basic' ),
		'bold italic' => __( 'Bold Italic', 'basic' )
		);
